        ...
        <CContainer>
          ...
          <CRow className="pb-5">
            <p style={{ textAlign: "justify" }}>
              ...
              which inform, educate and entertain millions of people in the UK and around the world. We're fully
              distributed teams of 85 people living in and working in 15 countries around the world. And we're working
              to share the news that are fresh and very updated in every country through this website.
            </p>
          </CRow>
        </CContainer>
      </div>
